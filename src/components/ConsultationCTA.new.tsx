...
export default function ConsultationCTA() {
  ...
  return (
    <section ref={ref} id="consultation" className="relative py-section bg-cream overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="glass-card p-8 md:p-12 lg:p-16 shadow-card">
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div>
                  <label className="block font-body text-caption text-bodytext/70 tracking-[0.15em] uppercase mb-3">
                    Full Name
                  </label>
                  <input
                    type="text"
              ...
              {/* Contact Information */}
              <div className="grid md:grid-cols-2 gap-8 border-t border-gold/20 pt-10 mb-10">
                <div>
              ...
              <div className="w-full flex justify-center">
                <button
                  type="button"
                  className="group inline-flex items-center px-12 py-5 bg-gold text-richblack font-body text-body-sm font-semibold tracking-wider uppercase transition-all duration-300 hover:bg-gold-light hover:shadow-gold-glow whitespace-nowrap"
                >
                  Begin Representation Inquiry
                  <ArrowRight
                    size={16}
