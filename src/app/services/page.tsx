    ...
    <LenisProvider>
      ...
      <main className="pt-20">
        ...
        <section className="py-24 md:py-32 bg-white relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1571624436279-b272aff752b5?ixlib=rb-4.0.3&auto=format&fit=crop&w=1800&q=80')] bg-cover bg-center opacity-10"></div>
